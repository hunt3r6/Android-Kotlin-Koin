...
import id.sidedi.kotlinkoin.BuildConfig
import id.sidedi.kotlinkoin.data.api.ApiHelper
import id.sidedi.kotlinkoin.data.api.ApiHelperImpl
import id.sidedi.kotlinkoin.data.api.ApiService
...
val appModule = module {
    ...
    single { provideRetrofit(get(), BuildConfig.BLOG) }
